...
namespace Dashboard.CashDBDataSetTableAdapters {
...
SELECT Id, Cedula_Cliente, Cuenta, Tipo_Transaccion, Fecha, Monto, Estado FROM Transacciones WHERE (Id = @Id)";
        ...
        public virtual int Fill(CashDBDataSet.TransaccionesDataTable dataTable) {
        ...
        public virtual CashDBDataSet.TransaccionesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CashDBDataSet.TransaccionesDataTable dataTable = new CashDBDataSet.TransaccionesDataTable();
        ...
        public virtual int FillByCedula(CashDBDataSet.TransaccionesDataTable dataTable, string Cedula_Cliente) {
        ...
        public virtual CashDBDataSet.TransaccionesDataTable GetDataByCedula(string Cedula_Cliente) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Cedula_Cliente == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CashDBDataSet.TransaccionesDataTable dataTable) {
